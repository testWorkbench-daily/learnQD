...
```bash
python analyze_correlation.py --start 20170101 --end 20251231 --timeframe d1 --threshold 0.3 --max-strategies 4 --results-dir backtest_results
```
...
### 数据文件
- `nq_m1_forward_adjusted.csv` - NQ期货1分钟数据（前向调整）
