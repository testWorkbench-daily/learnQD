...
用法:
    ...
    python forward_adjust.py --input nq_m1_all_backtrader.csv --output nq_m1_forward_adjusted.csv
"""
import pandas as pd
import numpy as np
...
def main():
    ...
    parser.add_argument('--input', default='/Users/hong/PycharmProjects/prepareQD/nq_m1_cleaned.csv',
                        help='输入文件')
    parser.add_argument('--output', default='/Users/hong/PycharmProjects/prepareQD/nq_m1_forward_adjusted.csv',
                        help='输出文件')
